...
const Cardone = () => {
 ...
 <div className='flex justify-center'> <div  className='bg-[#0e024f] text-white w-100 h-15 rounded-4xl flex justify-center items-center hover:cursor-pointer' >Apply Card . 10 USD</div>
 </div>
